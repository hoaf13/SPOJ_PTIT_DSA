...
int main(){
	...
	for(int i=0;i<n;i++){
		for(int j=0;j<n;j++){
			if(i>1 && j>1 && a[i][j]==a[i-1][j-1] && a[i-1][j-1]==a[i-2][j-2] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
			if(i>1 && a[i][j]==a[i-1][j] && a[i-1][j]==a[i-2][j] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
			if(i>1 && j<n-2 && a[i][j]==a[i-1][j+1] && a[i-1][j+1]==a[i-2][j+2] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
			if(j<n-2 && a[i][j]==a[i][j+1] && a[i][j+1]==a[i][j+2] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
			if(i<n-2 && j<n-2 && a[i][j]==a[i+1][j+1] && a[i+1][j+1]==a[i+2][j+2] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
			if(i<n-2 && a[i][j]==a[i+1][j] && a[i+1][j]==a[i+2][j] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
			if(i<n-2 && j>1 && a[i][j]==a[i+1][j-1] && a[i+1][j-1]==a[i+2][j-2] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
			if(j>1 && a[i][j]==a[i][j-1] && a[i][j-1]==a[i][j-2] && a[i][j]!='.'){
				cout<<a[i][j];
				stop=1;
				break;
			}
